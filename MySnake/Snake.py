...
class Game_Window(object):
    ...
    def blit_grid(self):
        for x in range(40):
            pygame.draw.aaline(self.screen,(0, 0, 0),(x*10, 0), (x*10, 400))
        for y in range(40):
            pygame.draw.aaline(self.screen, (0, 0, 0), (0, y * 10), (400, y * 10))
